...
eic_clib.write_asic_indirect_reg(0x4009, 0b00001111)
eic_clib.write_asic_indirect_reg(0x400A, 0b10000000)
eic_clib.write_asic_indirect_reg(0x400B, 0b01100000)
eic_clib.write_asic_indirect_reg(0x400C, 0b11010000)  #dacb pulser
...
eic_clib.write_asic_indirect_reg(0x4011, 0b00100011)
eic_clib.write_asic_indirect_reg(0x4012, 0b01111000)
...
eic_clib.write_asic_indirect_reg(0x4019, 0b00000111)
eic_clib.write_asic_indirect_reg(0x401A, 0b00000000)
eic_clib.write_asic_indirect_reg(0x401B, 0b00000100)
eic_clib.write_asic_indirect_reg(0x401E, 0b00000011)
eic_clib.write_asic_indirect_reg(0x4020, 0b11111111)
...
eic_clib.write_asic_indirect_reg(0x3, 0b00000100)
